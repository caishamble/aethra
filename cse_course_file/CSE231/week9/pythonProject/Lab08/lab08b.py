...
def display_map(data_map):
    ...
    #     continents_list = [] #create a sorted list of the continent keys
    #     # For each continent
    #         print(f"{continent}:") #continent in continents_list
    #     	  countries_list = [] #create a sorted list of the countries keys in the continents
    #           # For each country
    #                 print(f"{country:>10s} --> ",end = '') #country in countries_list
    #                 cities = [] #create a sorted list of the cities
...
def main():
    ...
    build_map(in_file1,in_file2,data_map)
