...
# print the last
card1 = player1_list[-1]
card2 = player2_list[-1]
print("Last card in hand of player #1:", card1)
print("Last card in hand of player #2:", card2)

print()

if card1.rank() == card2.rank():
    print( "Tie:", card1, "and", card2, "of equal rank" )
